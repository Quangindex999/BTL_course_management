...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="my_course.php" class="btn btn-secondary">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form method="POST" action="../../handle/teacher_course_process.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="instructor_name"
                                        value="<?php echo escape($course['instructor_name'] ?? $teacher_name); ?>" required readonly>
                                    <small class="text-muted">Tự động lấy từ thông tin của bạn</small>
                                </div>
                            </div>
